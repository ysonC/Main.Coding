...
<?php
$deleteMovie = $_GET['noMovie']; // change this
...
//$conn->query("DELETE from Movie where mvTitle = '$deleteMovie'"); // delete movie first

if (! $conn->query("DELETE from Movie where mvTitle = '$deleteMovie'")) echo "Error: " . $sql . "<br>" . $conn->error . "<br>";
else    echo "Movie succesfully removed.";
