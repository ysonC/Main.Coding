...
//$conn->query("DELETE from Actor where actname = '$deleteActor'");

if (!$conn->query("DELETE from Actor where actname = '$deleteActor'"))
{
echo "Error: " . $sql . "<br>" . $conn->error . "<br>";
echo "!! Try removing the Movie that the Actor is in first. !!";
}
else
{
echo "Actor has been successfully removed.";
}
